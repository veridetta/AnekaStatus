package com.vrcorp.anekastatusv2.db;
...
public class DBHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME="dbAnekaStatus";
    ...
    public final static String DATABASE_PATH = "/data/data/com.vrcorp.myblog/databases/";
