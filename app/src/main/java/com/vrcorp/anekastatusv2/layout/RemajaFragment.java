...
import com.vrcorp.anekastatusv2.adapter.RemajaAdapter;
import com.vrcorp.anekastatusv2.model.RemajaModel;
...
public class RemajaFragment extends Fragment {
    ...
    private RemajaAdapter mDataAdapter;
    private CardView cardNext, cardPrev;
    private String url="https://www.status.co.id/aneka/category/remaja/";
    ...
    public RemajaFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static RemajaFragment newInstance(String param1, String param2) {
        RemajaFragment fragment = new RemajaFragment();
    ...
    private class Remaja extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            baperDataList= new ArrayList<RemajaModel>();
            mDataAdapter = new RemajaAdapter( getActivity(), islamijudulList,
                    islamikategoriList,
            ...
            try {
                mBlogPagination = Jsoup.parse(new URL(url),90000);
            } catch (IOException e) {
                e.printStackTrace();
            }
