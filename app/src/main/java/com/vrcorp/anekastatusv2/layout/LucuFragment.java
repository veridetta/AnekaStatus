...
import com.vrcorp.anekastatusv2.adapter.LucuAdapter;
import com.vrcorp.anekastatusv2.model.LucuModel;
...
public class LucuFragment extends Fragment {
    ...
    private List<LucuModel> baperDataList;
    private LucuAdapter mDataAdapter;
    private CardView cardNext, cardPrev;
    private String url="https://www.status.co.id/aneka/category/lucu/";
    ...
    public static LucuFragment newInstance(String param1, String param2) {
        LucuFragment fragment = new LucuFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lucu, container, false);
    ...
    private void BaperCek(){
        baperDataList= new ArrayList<LucuModel>();
    ...
    private class Lucu extends AsyncTask<Void, Void, Void> {
        @Override
        protected Void doInBackground(Void... params) {
            ...
            baperDataList= new ArrayList<LucuModel>();
            mDataAdapter = new LucuAdapter( getActivity(), islamijudulList,
                    islamikategoriList,
