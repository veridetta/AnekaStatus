...
import com.vrcorp.anekastatusv2.adapter.RomantisAdapter;
import com.vrcorp.anekastatusv2.model.RomantisModel;
...
public class RomantisFragment extends Fragment {
    ...
    private List<RomantisModel> baperDataList;
    private RomantisAdapter mDataAdapter;
    private CardView cardNext, cardPrev;
    private String url="https://www.status.co.id/aneka/category/romantis/";
    ...
    Elements eList;
    public RomantisFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static RomantisFragment newInstance(String param1, String param2) {
        RomantisFragment fragment = new RomantisFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_romantis, container, false);
    ...
    private void BaperCek(){
        baperDataList= new ArrayList<RomantisModel>();
    ...
    private class Romantis extends AsyncTask<Void, Void, Void> {
        @Override
        protected Void doInBackground(Void... params) {
            ...
            baperDataList= new ArrayList<RomantisModel>();
            mDataAdapter = new RomantisAdapter( getActivity(), islamijudulList,
                    islamikategoriList,
