...
public class MotivasiFragment extends Fragment {
    ...
    private class Motivasi extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://mydemoblog19.blogspot.com/search/label/rekomendasi";
        ...
        protected void onPostExecute(Void result) {
            ...
            MotivasiAdapter mDataAdapter = new MotivasiAdapter( getActivity(), judulList, kategoriList,
