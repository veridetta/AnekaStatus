...
public class RomantisFragment extends Fragment {
    ...
    private class Romantis extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://mydemoblog19.blogspot.com/search/label/sport";
        ...
        protected void onPostExecute(Void result) {
            ...
            RomantisAdapter mDataAdapter = new RomantisAdapter( getActivity(), judulList, kategoriList,
