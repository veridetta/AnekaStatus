...
public class LucuFragment extends Fragment {
    ...
    private class Lucu extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://mydemoblog19.blogspot.com/search/label/makanan";
        ...
        protected void onPostExecute(Void result) {
            ...
            LucuAdapter mDataAdapter = new LucuAdapter( getActivity(), judulList, kategoriList,
