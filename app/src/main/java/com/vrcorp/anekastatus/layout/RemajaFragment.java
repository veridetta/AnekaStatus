...
public class RemajaFragment extends Fragment {
    ...
    private class Remaja extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://mydemoblog19.blogspot.com/search/label/gaya%20hidup";
        ...
        protected void onPostExecute(Void result) {
            ...
            RemajaAdapter mDataAdapter = new RemajaAdapter( getActivity(), judulList, kategoriList,
